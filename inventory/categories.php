...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <?php if ($canEdit): ?><a href="category_form.php" class="btn btn-brand"><i class="fa-solid fa-plus"></i> Add Category</a><?php endif; ?>
</div>
<div class="card p-3">
    ...
    <table class="table table-hover" id="catTable">
      ...
      <?php foreach ($categories as $c): ?>
        <tr>
          ...
          <td class="text-end">
            <?php if ($canEdit): ?><a href="category_form.php?id=<?= (int)$c['id'] ?>" class="btn btn-sm btn-outline-secondary"><i class="fa-solid fa-pen"></i></a><?php endif; ?>
            <?php if ($canManage): ?>
