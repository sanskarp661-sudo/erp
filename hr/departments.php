...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="department_form.php" class="btn btn-brand"><i class="fa-solid fa-plus"></i> Add Department</a>
</div>
<div class="card p-3">
    ...
    <table class="table table-hover" id="deptTable">
      ...
      <?php foreach ($departments as $d): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="department_form.php?id=<?= (int)$d['id'] ?>" class="btn btn-sm btn-outline-secondary"><i class="fa-solid fa-pen"></i></a>
